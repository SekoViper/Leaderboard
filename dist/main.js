...
eval("const formElm = document.getElementById('form');\nconst createData = () => {\n  formElm.addEventListener('submit', (event) => {\n    event.preventDefault();\n    const APIUrl = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/';\n    const formData = new FormData(formElm);\n    const data = new URLSearchParams(formData);\n\n    fetch(APIUrl, {\n      method: 'POST',\n      body: data,\n    }).then((data) => console.log(data));\n  });\n};\n\n// const getData = async () => {\n//   const APIUrlEndPoint = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/:id/scores/';\n//   const responseData = await fetch(APIUrlEndPoint);\n\n//   console.log(responseData);\n// };\n\nexports = { createData };\n\n//# sourceURL=webpack://leaderboard/./modules/data.js?");
